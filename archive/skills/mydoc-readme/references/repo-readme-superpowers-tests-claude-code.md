# Repo README: superpowers / tests/claude-code/README.md

- Source repo: `superpowers`
- Source path: `tests/claude-code/README.md`
- Original file: `/Users/jordanmamroud/mylab/repos-study/superpowers/tests/claude-code/README.md`
