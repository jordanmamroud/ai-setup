...
4. Links named-file mappings — Claude: `global/CLAUDE.md` → `~/.claude/CLAUDE.md`; Codex: `global/AGENTS.md` → `~/.codex/AGENTS.md` (each replaces an empty file, never a real one).
