...
The `zsync` zsh function copies `~/.zshrc` into this folder and pushes it. Raycast script commands live in `raycast-scripts/`.
...
This folder contains: `README.md`, `CLAUDE.md` (this file), `AGENTS-system.md` (Codex voice rules), `zshrc` (version-controlled backup of `~/.zshrc`), `raycast-scripts/`, `ghostty/`.
