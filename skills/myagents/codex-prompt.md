...
Promote a polished global Codex behavior rule into `/Users/jordanmamroud/mylab/ai-setup/agent-rules/AGENTS.md`, then commit and push it.

Use only when the user explicitly invokes `/myagents` or asks to add/update global AGENTS.md rules.

## Source of truth

- Canonical file: `/Users/jordanmamroud/mylab/ai-setup/agent-rules/AGENTS.md`
...
1. Read the canonical `agent-rules/AGENTS.md`.
...
6. Run:
   ...
   - `test "$(readlink "$HOME/.codex/AGENTS.md")" = "/Users/jordanmamroud/mylab/ai-setup/agent-rules/AGENTS.md"`
7. Review `git diff -- agent-rules/AGENTS.md`.
